/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config scripts/types-config.json --env-interface FaultlineRuntimeEnv` (hash: 526805ef837222fbf8f0cf6a905e58ea)
// Runtime types generated with workerd@1.20260515.1 2026-09-01 nodejs_compat
interface __BaseEnv_FaultlineRuntimeEnv {
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env extends __BaseEnv_FaultlineRuntimeEnv {}
}
interface FaultlineRuntimeEnv extends __BaseEnv_FaultlineRuntimeEnv {}
